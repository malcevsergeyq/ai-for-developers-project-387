 ...
 * разработке, контейнеру проверки Hexlet и публичному демо: на пустом календаре путь
 * записи некуда пройти. Выключают его там, где демо-данные мешают, — значением `false`.
 *
